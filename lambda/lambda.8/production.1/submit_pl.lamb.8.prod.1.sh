#!/bin/bash
#SBATCH --job-name=pl.lamb.8.prod.1
#SBATCH --output=pl.lamb.8.prod.1.err
...
srun -N1 -n20 $AMBERHOME/bin/pmemd.MPI -O -i pl.lamb.8.prod.1.in -o pl.lamb.8.prod.1.log -p ../../../1F40_ligand_solv.prmtop -c ../../lambda.7/production.1/pl.lamb.7.prod.1.rst -ref ../../lambda.7/production.1/pl.lamb.7.prod.1.rst -inf pl.lamb.8.prod.1.mdinfo -e pl.lamb.8.prod.1.en -x pl.lamb.8.prod.1.ncdf -r pl.lamb.8.prod.1.rst
